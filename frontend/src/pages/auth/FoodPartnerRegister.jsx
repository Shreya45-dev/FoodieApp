...
const navigate=useNavigate()
  ...
  return (
    ...
    <div className=' h-[500px] w-[340px] md:w-[440px] border-2 rounded-xl bg-blue-200 border-zinc-500 flex items-center justify-center mt-20'>
      <div className="h-[480px] md:w-[420px] w-[320px] ">
